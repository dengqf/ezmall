package com.ezmall.utils.image;
...
public class MagicImageScale {
    ...
    public static void resizeFix(File srcFile, File destFile, int boxWidth,
        ...
        magick.ImageInfo info = new magick.ImageInfo(srcFile.getAbsolutePath());
    ...
    private static void imageMark(MagickImage image, magick.ImageInfo info, int width,
                                  int height, int pos, int offsetX, int offsetY, String text,
                                  Color color, int size, int alpha) throws MagickException {
        ImageHelp.Position p = ImageHelp.markPosition(width, height, pos, offsetX,
                offsetY);
    ...
    private static void imageMark(MagickImage image, magick.ImageInfo info, int width,
        ...
        ImageHelp.Position p = ImageHelp.markPosition(width, height, pos, offsetX,
                offsetY);
        MagickImage mark = new MagickImage(new magick.ImageInfo(markFile
                .getAbsolutePath()));
    ...
    public static void main(String[] args) throws Exception {
        ...
        MagicImageScale.resizeFix(
                new File("d://99854441_01_b.jpg"), new File(
                "d://99854441_01_b.png"), 400, 200);
