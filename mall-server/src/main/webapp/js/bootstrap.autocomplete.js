!function ($) {
    ...
    Autocomplete.prototype = {
        ...
        constructor: Autocomplete, processObj: 0, formatItem: function (item) {
            ...
            items = $($.parseJSON(items)).map(function (i, item) {
    ...
    $.fn.autocomplete.defaults = {
        source: [], items: 8, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', minLength: 1, delay: 500
    }
